...
static const char *fonts[]                  = { "terminus:size=12", "TerminessTTF Nerd Font:size=9" };
...
const char *spcmd2[] = {"st", "-n", "spfm", "-g", "150x50", "-e", "ranger", NULL };
const char *spcmd3[] = {"keepassxc", NULL };
const char *spcmd4[] = {"st", "-n", "spmpd", "-g", "150x50", "-e", "ncmpcpp", NULL };
...
static const char *powercmd[] = { "/home/luis/.dwm/scripts/dmenu-power.sh", NULL };
...
static const char *voltogglecmd[] = { "/home/luis/.dwm/scripts/vol-toggle.sh", NULL };
